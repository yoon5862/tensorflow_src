...
typedef struct TfLiteDelegate {
  ...
  TfLiteStatus (*opt_node)(TfLiteContext* context, struct TfLiteDelegate* delegate, TfLiteIntArray *&ops_to_replace) = nullptr;
  TfLiteStatus (*CustomPrepare)(TfLiteContext* context, struct TfLiteDelegate* delegate, TfLiteIntArray *ops_to_replace) = nullptr;
